...
import (
	...
	"errors"
	"fmt"
	// imre - optimizaition removed: "internal/cpu"
	"io"
	"net"
	"strings"
	"sync"
...
type Config struct {
	...
	// imrer: if this is not nil, it will be used to mount a serverKeyExchange attack
	// in certificateRequestMsg (so you don't need to actually have these certificates, only their names)
	AcceptableCAs [][]byte
	SkipKeyexchange bool
	SkipClientCertificateVerification bool
}
